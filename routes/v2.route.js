...
router.get('/version-number/:channel', v2_controller.getVersionNumber)
router.get('/download/:launcher/:channel', v2_controller.getDownload)
router.post('/update', v2_controller.postUpdate)
